...
def profile_view(request):
    ...
    if request.method == 'POST' and 'add_preference' in request.POST:
        ...
        if preference_form.is_valid():
            ...
            preference.save()
            messages.success(request, f'Added "{preference.topic_keyword}" to your preferences!')
            return redirect('profile')
    ...
    if request.method == 'POST' and 'remove_preference' in request.POST:
        ...
        try:
            ...
            preference.delete()
            messages.success(request, f'Removed "{preference.topic_keyword}" from your preferences!')
            return redirect('profile')
