...
class UsersModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self.preference = UserPreference.objects.create(
            user=self.user, topic_keyword="Technology"
        )
    ...
    def test_unique_preference(self):
        ...
        with self.assertRaises(Exception):
            UserPreference.objects.create(user=self.user, topic_keyword="Technology")

        # Should be able to create a different preference
        pref2 = UserPreference.objects.create(user=self.user, topic_keyword="Politics")
        ...
        pref3 = UserPreference.objects.create(user=user2, topic_keyword="Technology")
...
class UsersViewTests(TestCase):
    ...
    def test_add_preference(self):
        ...
        response = self.client.post(
            reverse("profile"), {"add_preference": True, "topic_keyword": "Technology"}
        )
        ...
        self.assertTrue(
            any('Added "Technology" to your preferences' in str(m) for m in messages)
        )
...
class UsersFormTests(TestCase):
    ...
    def test_user_preference_form_valid(self):
        ...
        form_data = {"topic_keyword": "Technology"}
