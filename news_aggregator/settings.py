...
SECRET_KEY = config(
    "SECRET_KEY",
    default="django-insecure-+7-azsk6(-)k&a&j!qln8u(e#e=-4)59x(!-ma&qa)q94cuzbq",
)
...
NEWS_API_ENDPOINT = config(
    "NEWS_API_ENDPOINT", default="https://newsapi.org/v2/top-headlines"
)
