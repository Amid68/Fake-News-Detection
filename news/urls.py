...
urlpatterns = [
    ...
    path('article/<int:article_id>/save/', views.save_article_view, name='save_article'),
    path('article/<int:article_id>/unsave/', views.unsave_article_view, name='unsave_article'),
    ...
    path('models/comparison/', views.detection_model_comparison_view, name='model_comparison'),
]