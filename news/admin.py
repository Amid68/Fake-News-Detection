...
class ArticleAdmin(admin.ModelAdmin):
    list_display = ('title', 'source', 'publication_date', 'has_detection_result', 'view_count')
...
class FakeNewsDetectionResultAdmin(admin.ModelAdmin):
    list_display = ('article', 'credibility_score', 'credibility_category',
...
class DetectionModelMetricsAdmin(admin.ModelAdmin):
    list_display = ('model_name', 'accuracy', 'f1_score', 'avg_processing_time',
                    'avg_memory_usage', 'parameter_count', 'efficiency_score')
